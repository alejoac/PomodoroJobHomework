...
GO
PRINT N'Creating unnamed constraint on [dbo].[Tasks]...';


GO
ALTER TABLE [dbo].[Tasks]
    ADD DEFAULT ((0)) FOR [TaskIsCompleted];
...
GO
ALTER TABLE [dbo].[Tasks]
    ADD DEFAULT ((0)) FOR [TaskIsDiscarded];
...
GO
ALTER TABLE [dbo].[Tasks]
    ADD CONSTRAINT [FK_tUsers_tTasks] FOREIGN KEY ([UserId]) REFERENCES [dbo].[Users] ([UserId]);
